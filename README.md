...
- Mac Users
    - Open a text editor on your terminal
    ```
    vim simple.yaml
    ```
    - Copy paste the the contents of this file into it

    - Intialize the gateway
    ```
    skupper gateway init --config simple.yaml --type docker
    ```
    - You should see an output similar to the one below 
    ```,nocopy
